...
void ScenePantallaIni::init()
{
	...
	CargaImagen = ResourceManager::getInstance()->loadAndGetGraphicID("gauntlet.png");//Cargo los graficos(imagenes)
	mReinit = false;
}
...
void ScenePantallaIni::update()
{
	...
	{
		ResourceManager::getInstance()->removeGraphic("gauntlet.png");
